       ...
       <?php require_once('inc/header.php');?>
        <div class="container-fluid body-section">
            <div class="row">
                ...
                <div class="col-md-9">
                    <h1 style="color: #2A9FC1;"><i class="fa fa-user"></i> Edit profile <small>Edit profile datails</small></h1><hr>
                    <ol class="breadcrumb">
                    ...
                    if(isset($_POST['submit'])){
                        ...
                        {
                            $update_query = "UPDATE `cms`.`users` SET `first_name` = '$first_name',`last_name` = '$last_name',`image` = '$image',`datails` = '$datails',`donor_status` ='$status'";
                             if(isset($image)){
                            ...
                            if(mysqli_query($con,$update_query)){
                                $msg="Profile datails has been updated";
                            ...
                            {
                                $error="Profile datails has not been updated";
                            }
                        }
                    }
                    ?>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        <option value="ready" <?php if($e_status=='ready') echo"selected";?> >Ready</option>
                                        <option value="unready" <?php if($e_status=='unready') echo"selected";?> >Unready</option>
                                    </select>
                                </div>
                                <div class="form-group">
