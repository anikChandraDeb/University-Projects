...
public class addadmin extends AppCompatActivity {
                ...
                if (isValidDate(birthdates, dateFormat)) {
                    if(bloodgroups.isEmpty()) {Toast.makeText(this,"Blood Group Empty",Toast.LENGTH_SHORT).show();}
                        ...
                        if(districts.isEmpty()) Toast.makeText(this,"District Empty",Toast.LENGTH_SHORT).show();
                            ...
                            if(res.getCount()>=1) {
                                while (res.moveToNext()) {
                                    ...
                                    if (maildb.equals(mails)) {
                                        Toast.makeText(addadmin.this, "Mail Already Exists", Toast.LENGTH_SHORT).show();
                                        return;
                                    } else if (phonedb.equals(phones)) {
                                        Toast.makeText(addadmin.this, "Phone Already Exists", Toast.LENGTH_SHORT).show();
                                        return;
                                    }
                            ...
                            Boolean checkinsertdata = DB.insertuserdata(names,mails,passwords,birthdates,bloodgroups,phones,districts,"NULL","0","Admin","1");
                            if(checkinsertdata == true){
                                Toast.makeText(addadmin.this, "Added Admin", Toast.LENGTH_SHORT).show();
                                Intent intent=new Intent(this,MainActivity.class);
                                startActivity(intent);
                            }

                            else
                                Toast.makeText(addadmin.this, "Not Added Admin", Toast.LENGTH_SHORT).show();
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(addadmin.this,admindeshboard.class);
        startActivity(intent);
        super.onBackPressed();
    }
}